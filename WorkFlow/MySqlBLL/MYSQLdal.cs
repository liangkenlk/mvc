...
namespace WorkFlow
{
    public class MYSQLdal<T, R> : Idal<T, R> where T : DataTable where R : DataRow
    {
        ...
        public MYSQLdal()
        {
            ...
            this.cmd = new MySqlCommand("select * from " + this.TableName + "", this.con);
        ...
        public MYSQLdal(MyDBContext context)
        {
            T table = Activator.CreateInstance<T>();
            this.db = context;
        ...
        public void Delete(T table)
        {
            ...
            MySqlCommandBuilder builder = new MySqlCommandBuilder(this.adp);
        ...
        {
            this.db.Open();
            this.db.cmd.CommandText = sql.Replace("[","").Replace("]","");
        ...
        {
            this.db.Open();
            this.cmd.CommandText = sql.Replace("[", "").Replace("]", "");
        ...
        {
            this.db.Open();
            this.adp.SelectCommand.CommandText = sql.Replace("[", "").Replace("]", "");
            T dataTable = Activator.CreateInstance<T>();
            this.adp.Fill(dataTable);
            this.db.End();
            return dataTable;
