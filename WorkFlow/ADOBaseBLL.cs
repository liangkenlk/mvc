namespace WorkFlow
{
    ...
    public class ADOBaseBLL<T, R> : IBaseBLL<T, R> where T: DataTable where R: DataRow
    {
        public ADOdal<T, R> dal;
        public string TableName
        { get { return this.dal.TableName; } }

        public ADOBaseBLL(DBContext context)
        {
            this.dal = new ADOdal<T, R>(context);
        }
